...
samples <- data.frame('group'=group, 'age'=age, 'aINS_RIN'=aINS_RIN, 'alcohol'=alcohol, 'medic'=medic)
...
deg <-DGEList(counts = FPKM_antins, samples = samples, group = group, genes = genes, remove.zeros = TRUE)
...
write.csv(result,file="DEGlist_antins_M.csv")
#write.csv(result,file="DEGlist_antins_F.csv")
```
